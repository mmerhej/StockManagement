...
public class AddCustomerActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        customerList = Customer.getPrefArraylist(Config.PREF_KEY_LIST_CUSTOMERS, AddCustomerActivity.this);
        ...
        getCreate_btn().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(getFullName_et().getText().toString().trim().length() < 1 ||
                    ...
                    ArrayList<SpinnerItem> spinnerItemList = SpinnerItem.getPrefArraylist(Config.PREF_KEY_LIST_CUSTOMER_SPINNER, AddCustomerActivity.this);

                    spinnerItemList.add(new SpinnerItem(Integer.parseInt(
                            getPhoneNumber_et().getText().toString()),
                            getFullName_et().getText().toString()));
                    ...
                    Methods.savePrefObject(spinnerItemList, Config.PREF_KEY_LIST_CUSTOMER_SPINNER, AddCustomerActivity.this);

                    sendBroadcast(new Intent(Config.ACTION_NEW_CUSTOMER));
                    finish();
                }
            }
        });
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (shouldShowRequestPermissionRationale(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            SnackS.snackInfoLarge(AddCustomerActivity.this, getResources().getString(R.string.permission_storage));
                        }
    ...
    private void takePicture() {
        ...
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(state)) {
                mFileTemp = new File(Environment.getExternalStorageDirectory().toString() + "/" + TEMP_PHOTO_FILE_PATH + TEMP_PHOTO_FILE_NAME + customerList.size() + ".jpg");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            mFileTemp = new File(getFilesDir().toString() + "/" + TEMP_PHOTO_FILE_PATH + TEMP_PHOTO_FILE_NAME + customerList.size() + ".jpg");
        }
